...
public class FavoriteAddWindow extends javax.swing.JFrame {
    ...
    public FavoriteAddWindow(MainWindow mainwindow) {
        this.mainwindow = mainwindow;
        initComponents();
        init();
    }

    public FavoriteAddWindow(MainWindow mainwindow, String Name, String Path, Folder folder) {
        this.mainwindow = mainwindow;
        this.Name = Name;
        this.Path = Path;
    ...
    FavoriteAddWindow(MainWindow mainwindow, SettingsWindow settingswindow) {
    ...
    private void initComponents() {
        ...
        jPnlFavorites.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jPnlFavoritesKeyTyped(evt);
            }
        });
    ...
    private void jBtnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOKActionPerformed
        ...
        //create new Favorite
        FavoriteGame FG = new FavoriteGame(Name, Path, EmulatorID, Icon, Comment);
    ...
    private void jPnlFavoritesKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPnlFavoritesKeyTyped
        switch(evt.getKeyCode()){
            case KeyEvent.VK_ESCAPE:
                //escape hit, close
                this.dispose();
    ...
    }//GEN-LAST:event_jPnlFavoritesKeyTyped
    ...
    private void jBtnBrowsePathKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jBtnBrowsePathKeyReleased
        if(evt.getKeyCode() != KeyEvent.VK_ENTER){
            KeyHit(evt.getKeyCode());
        }
    }//GEN-LAST:event_jBtnBrowsePathKeyReleased
