 ...
 * @author sj
 */
public class EmulatorEditWindow extends javax.swing.JDialog {

    /** Creates new form EmulatorAdd */
    public EmulatorEditWindow(java.awt.Frame parent, boolean modal, Emulator EmulatorName) {
        super(parent, modal);
        myEmulator = EmulatorName;
        initComponents();
        init2();
    }
    ...
    private void init2(){
        //get default values
        Name = myEmulator.getName();
        Description = myEmulator.getDescription();
        Path = myEmulator.getPath();
        Types = myEmulator.getFileTypes();
        Args = myEmulator.getArguments();
        //fill up default values
        txtName.setText(Name);
        txtDescription.setText(Description);
        txtPath.setText(Path);
        txtTypes.setText(Types);
    ...
    myEmulator.setName(Name);
    myEmulator.setDescription(Description);
    myEmulator.setPath(Path);
    myEmulator.setFileTypes(Types);
    myEmulator.setArguments(Args);
    //close the form
    this.dispose();
    ...
    private String Name, Description, Path, Types, Args;
